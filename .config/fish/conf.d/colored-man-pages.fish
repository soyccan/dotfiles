...
# begin
#   # set the colored less to be default pager
#   # so that <fish builtin command> --help have colors!
#   set -l environment (colored)
#   set -x PAGER "env '$environment' less"
# end

function man --description 'colored man'
    command env (colored) (command -s man) $argv
end
